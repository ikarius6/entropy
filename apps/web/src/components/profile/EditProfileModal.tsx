...
function Field({ label, placeholder, value, onChange, multiline, hint }: FieldProps) {
  const base =
    "w-full bg-background/50 border border-border rounded-lg px-3 py-2 text-sm text-white placeholder:text-muted/60 focus:outline-none focus:border-primary transition-colors";
